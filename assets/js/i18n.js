...
const I18N = (function(){
  const DICT = {
    en: {
      ...
      'dyn.depart':       '✈ <span><b>Jul 23 · departure</b> — check out, fly home from KUL.</span>',
      'dyn.flyBack':      '✈ fly PEN → KUL',
      'dyn.pick':         'your pick',
      /* new — phase 1 */
      ...
      'flights.out':     'KUL → PEN',
      'flights.back':    'PEN → KUL',
      'fx.group':        'Exchange rates',
      'fx.krw':          '1 KRW =',
      'fx.cny':          '1 CNY =',
      'fx.refresh':      '↻ refresh',
      'fx.updated':      'rates updated {t}',
      'fx.offline':      'using saved rates (offline)',
      'bd.flightsOut':   'Flights KUL→PEN',
      'bd.flightsBack':  'Flights PEN→KUL',
      ...
      'method.weather':  '<b style="color:var(--ink)">Weather &amp; packing.</b> July in KL &amp; Penang: hot (28–33°C), humid (80%+), afternoon thunderstorms. Pack: lightweight cotton/linen, rain jacket, umbrella, sunscreen, insect repellent, comfortable walking shoes, universal adapter (Type G).',
    },
    ...
    zh: {
      ...
      'dyn.depart':       '✈ <span><b>7月23 · 离程</b> — 退房，从吉隆坡飞回家。</span>',
      'dyn.flyBack':      '✈ 飞 槟城 → 吉隆坡',
      'dyn.pick':         '你的选择',
      /* new — phase 1 */
      'budget.group':    '你们的预算',
      'budget.you':      '凯鲁',
      ...
      'fx.refresh':      '↻ 刷新',
      'fx.updated':      '汇率更新于 {t}',
      'fx.offline':      '使用已保存汇率（离线）',
      'bd.flightsOut':   '机票 吉隆坡→槟城',
      'bd.flightsBack':  '机票 槟城→吉隆坡',
      'share.btn':       '分享方案',
      'share.copied':    '已复制！',
      'links.book':      '↗ 预订',
      'links.verify':    '↗ 验证票价',
      ...
      'reset.btn':       '恢复默认设置',
      'print.btn':       '打印方案',
      'method.weather':  '<b style="color:var(--ink)">天气与打包。</b>七月吉隆坡与槟城：炎热 (28–33°C)、潮湿 (80%+)、午后雷阵雨。携带：轻薄棉麻衣物、雨衣、雨伞、防晒霜、驱蚊剂、舒适步行鞋、万用转换插头 (Type G)。',
    },
  };
