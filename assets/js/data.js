  ...
  { date:{en:'Jul 16 · Thu', zh:'7月16 · 周四'}, city:'kl', icon:'✈️',
    ...
    sched:[
      ...
      { t:'21:00–22:00', type:TYPE.MEAL, mapUrl:'https://maps.google.com/?q=Seoul+Garden+LaLaport+BBCC+Kuala+Lumpur',
        cost:'RM 220',
        txt:{en:'Dinner at Seoul Garden, LaLaport BBCC — a short walk from the hotel (~RM220).', zh:'在酒店旁 LaLaport BBCC 的 Seoul Garden 晚餐（约RM220）。'} },
    ],
  ...
  { date:{en:'Jul 17 · Fri', zh:'7月17 · 周五'}, city:'kl', icon:'🏮',
    ...
    sched:[
      ...
      { t:'18:00–20:00', type:TYPE.MEAL, done:true, cost:'RM 343', confirm:'CT4J9Q',
        ...
        txt:{en:'Dinner at Park Lounge, Park Hyatt (booked, 2 pax): Umai Ikan Merah, Daging Dendeng Cili Berapi, Nasi Goreng Ketam Bunga, Butter Chicken, Bendi Cabai Tumbuk (~RM343).', zh:'于柏悦 Park Lounge 晚餐（已预订，2 人）：Umai Ikan Merah、Daging Dendeng Cili Berapi、花蟹炒饭、黄油鸡、Bendi Cabai Tumbuk（约RM343）。'} },
  ...
  { date:{en:'Jul 18 · Sat', zh:'7月18 · 周六'}, city:'kl', icon:'🕌',
    ...
    sched:[
      ...
      { t:'11:00–14:30', type:TYPE.SIGHTSEEING,
        ...
        cost:'RM 40',
        txt:{en:'Old KL Railway Station → Masjid Negara → Islamic Arts Museum (RM40, student RM10).', zh:'吉隆坡旧火车站 → 国家清真寺 → 伊斯兰艺术博物馆（RM40，学生 RM10）。'} },
      { t:'11:00–14:30', type:TYPE.SIGHTSEEING,
      ...
      { t:'20:00–22:00', type:TYPE.MEAL, done:true, cost:'RM 500',
        ...
        txt:{en:'Dinner at Arté 66 Restaurant & Bar — dinner / couple set, confirmed for 2 adults (~RM500).', zh:'于 Arté 66 Restaurant & Bar 晚餐 —— 晚餐/双人套餐，已确认 2 位成人（约RM500）。'} },
    ],
  ...
  { date:{en:'Jul 19 · Sun', zh:'7月19 · 周日'}, city:'pg', icon:'🌴',
    ...
    sched:[
      ...
      { t:'19:00–21:00', type:TYPE.MEAL, done:true, cost:'RM 316',
        ...
        txt:{en:'Tepi Laut “Roast Night” buffet dinner, poolside (booked 19:30, ~RM316).', zh:'池畔 Tepi Laut 「Roast Night」自助晚餐（已订 19:30，约RM316）。'} },
    ],
  ...
  { date:{en:'Jul 20 · Mon', zh:'7月20 · 周一'}, city:'pg', icon:'🌊',
    ...
    sched:[
      ...
      { t:'13:30–14:30', type:TYPE.MEAL, cost:'RM 120',
        ...
        txt:{en:'Lunch at Todak Waterfront (~RM120).', zh:'于 Todak Waterfront 午餐（约RM120）。'} },
      ...
      { t:'20:00–22:00', type:TYPE.MEAL, cost:'RM 200',
        ...
        txt:{en:'Filipino Night Market + Handicraft Market — dinner and souvenir browsing (~RM200).', zh:'菲律宾夜市 + 手工艺市场 —— 晚餐与手信淘宝（约RM200）。'} },
    ],
  ...
  { date:{en:'Jul 21 · Tue', zh:'7月21 · 周二'}, city:'pg', icon:'🏝️',
    ...
    sched:[
      ...
      { t:'20:00–22:00', type:TYPE.MEAL, done:true, cost:'RM 150',
        ...
        txt:{en:'Dinner at Rooftop Bar & Grill, Hilton Kota Kinabalu (booked, à la carte, ~RM150).', zh:'于亚庇希尔顿 Rooftop Bar & Grill 晚餐（已预订，单点，约RM150）。'} },
    ],
  ...
  { date:{en:'Jul 22 · Wed', zh:'7月22 · 周三'}, city:'kl', icon:'🍽️',
    ...
    sched:[
      ...
      { t:'20:30–22:30', type:TYPE.MEAL, done:true, cost:'RM 500',
        ...
        txt:{en:'Dinner at Curate, Four Seasons Hotel KL — booked via OpenTable, ~RM500; timing depends on actual arrival.', zh:'于吉隆坡四季酒店 Curate 晚餐 —— 已通过 OpenTable 预订，约RM500；时间以实际到达为准。'} },
