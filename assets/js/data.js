...
/* ---------- itinerary — the shared 7 days, time-slot schedule ---------- */
const ITIN = [
  { date:{en:'Jul 16 · Thu', zh:'7月16 · 周四'}, city:'kl',
    title:{en:'Arrival · Park Hyatt check-in', zh:'抵达 · 柏悦入住'},
    sched:[
      { t:'17:00–18:00', txt:{en:'Head to the airport (KL Ekspres).', zh:'前往机场（KL Ekspres）。'} },
      { t:'18:00–21:00', txt:{en:'Land at KLIA Terminal 1 (MH377). 19:20 booked premium transfer to Park Hyatt Kuala Lumpur (Merdeka 118) — check in for 3 nights, breakfast included.', zh:'抵达吉隆坡国际机场 1 号航站楼（MH377）。19:20 已订高级专车前往吉隆坡柏悦酒店（Merdeka 118）—— 入住 3 晚，含早餐。'} },
      { t:'21:00–22:00', txt:{en:'Dinner at Seoul Garden, LaLaport BBCC — a short walk from the hotel (~RM220).', zh:'在酒店旁 LaLaport BBCC 的 Seoul Garden 晚餐（约RM220）。'} },
    ],
  ...
  { date:{en:'Jul 17 · Fri', zh:'7月17 · 周五'}, city:'kl',
    ...
    sched:[
      { t:'09:00–10:30', txt:{en:'Hotel breakfast (included).', zh:'酒店早餐（已含）。'} },
      { t:'12:00–14:30', txt:{en:'Lunch + Pasar Seni (Central Market) — on foot.', zh:'午餐 + 逛中央艺术坊（Pasar Seni）—— 步行。'} },
      { t:'14:30–15:30', txt:{en:'Heritage walk: Guan Di Temple, Sri Maha Mariamman Temple, Kwai Chai Hong, Chan See Shu Yuen clan house.', zh:'古迹漫步：关帝庙、斯里玛哈马里安曼兴都庙、鬼仔巷、陈氏书院。'} },
      { t:'15:30–17:30', txt:{en:'Back to the hotel to rest and freshen up.', zh:'回酒店休息、收拾。'} },
      { t:'18:00–20:00', txt:{en:'Dinner at Park Lounge, Park Hyatt (booked, 2 pax): Umai Ikan Merah, Daging Dendeng Cili Berapi, Nasi Goreng Ketam Bunga, Butter Chicken, Bendi Cabai Tumbuk (~RM343).', zh:'于柏悦 Park Lounge 晚餐（已预订，2 人）：Umai Ikan Merah、Daging Dendeng Cili Berapi、花蟹炒饭、黄油鸡、Bendi Cabai Tumbuk（约RM343）。'} },
      { t:'20:00–22:00', txt:{en:'Night walk: Sultan Abdul Samad Building, River of Life, Dataran Merdeka, I Love KL sign, Kolam Biru.', zh:'夜游：苏丹阿都沙末大厦、生命之河、独立广场、I Love KL 打卡点、蓝池。'} },
    ],
  ...
  { date:{en:'Jul 18 · Sat', zh:'7月18 · 周六'}, city:'kl',
    ...
    sched:[
      { t:'09:00–10:30', txt:{en:'Hotel breakfast (included).', zh:'酒店早餐（已含）。'} },
      { t:'11:00–14:30', txt:{en:'Old KL Railway Station → Masjid Negara → Islamic Arts Museum (RM40, student RM10) → Royal Police Museum → Water Jet, Heliconia Garden, Bamboo Playhouse, Oasis Garden Waterfall. Grab over.', zh:'吉隆坡旧火车站 → 国家清真寺 → 伊斯兰艺术博物馆（RM40，学生 RM10）→ 皇家警察博物馆 → Water Jet、Heliconia 花园、竹亭、Oasis 花园瀑布。Grab 前往。'} },
      { t:'14:00–15:30', txt:{en:'KL Tower + Malay-Thai lunch nearby.', zh:'吉隆坡塔 + 附近马来-泰式午餐。'} },
      { t:'15:30–17:30', txt:{en:'The Exchange TRX — luxury-mall browsing (take the LRT).', zh:'逛 TRX Exchange 奢侈品商场（乘 LRT）。'} },
      { t:'17:30–19:30', txt:{en:'Back to the hotel — pack for tomorrow\'s checkout.', zh:'回酒店 —— 为明日退房收拾行李。'} },
      { t:'20:00–22:00', txt:{en:'Dinner at Arté 66 Restaurant & Bar — dinner / couple set, confirmed for 2 adults (~RM500).', zh:'于 Arté 66 Restaurant & Bar 晚餐 —— 晚餐/双人套餐，已确认 2 位成人（约RM500）。'} },
    ],
  ...
  { date:{en:'Jul 19 · Sun', zh:'7月19 · 周日'}, city:'pg',
    ...
    sched:[
      { t:'09:00–10:00', txt:{en:'Hotel breakfast (included); check out before 12:00.', zh:'酒店早餐（已含）；12:00 前退房。'} },
      { t:'10:35–12:00', txt:{en:'Booked transfer Park Hyatt → KLIA Terminal 1 (KRW 34,974, paid).', zh:'已订专车 柏悦 → 吉隆坡国际机场 1 号航站楼（KRW 34,974，已付）。'} },
      { t:'13:30–16:00', txt:{en:'Batik Air OD1004, business class, KUL T1 → BKI T1.', zh:'峇迪航空 OD1004 商务舱，KUL T1 → BKI T1。'} },
      { t:'16:00–18:00', txt:{en:'Grab (~1 h) to Shangri-La Rasa Ria, Pantai Dalit, Tuaran — Garden Wing Deluxe Sea View Twin, 1 night with breakfast.', zh:'Grab（约 1 小时）前往杜亚兰莎利雅香格里拉 —— 花园翼豪华海景双床房，1 晚含早。'} },
      { t:'19:00–21:00', txt:{en:'Tepi Laut “Roast Night” buffet dinner, poolside (booked 19:30, ~RM316).', zh:'池畔 Tepi Laut 「Roast Night」自助晚餐（已订 19:30，约RM316）。'} },
    ],
  ...
  { date:{en:'Jul 20 · Mon', zh:'7月20 · 周一'}, city:'pg',
    ...
    sched:[
      { t:'09:00–10:30', txt:{en:'Resort breakfast (included); check out before 12:00.', zh:'度假村早餐（已含）；12:00 前退房。'} },
      { t:'12:00–13:30', txt:{en:'Rasa Ria → The Shore Kota Kinabalu by Meetstay (walk or Grab): Family Suite “Lux Balcony & Seaview” B1613, 2 nights, check-in from 15:00.', zh:'莎利雅 → The Shore Kota Kinabalu by Meetstay(步行或 Grab)：家庭套房「Lux Balcony & Seaview」B1613，2 晚，15:00 起入住。'} },
      { t:'13:30–14:30', txt:{en:'Lunch at Todak Waterfront (~RM120).', zh:'于 Todak Waterfront 午餐（约RM120）。'} },
      { t:'15:00–18:30', txt:{en:'Sightseeing: I Love KK sign, Todak Waterfront, KK Waterfront.', zh:'观光：我爱亚庇打卡点、Todak 海滨、亚庇海滨。'} },
      { t:'20:00–22:00', txt:{en:'Dinner at the Filipino Night Market + Handicraft Market (~RM200).', zh:'菲律宾夜市 + 手工艺市场晚餐（约RM200）。'} },
    ],
  ...
  { date:{en:'Jul 21 · Tue', zh:'7月21 · 周二'}, city:'pg',
    ...
    sched:[
      { t:'06:00–07:30', txt:{en:'Early breakfast, gear up for the island day.', zh:'早起早餐，为跳岛做准备。'} },
      { t:'07:30–08:00', txt:{en:'Grab to Jesselton Point Port.', zh:'Grab 前往 Jesselton Point 码头。'} },
      { t:'08:30–15:30', txt:{en:'Sapi & Manukan islands — beach, snorkelling + parasailing (booked & paid, entry and boat fees included).', zh:'沙庇岛与马努干岛 —— 沙滩、浮潜 + 帆伞（已订已付，含门票与船票）。'} },
      { t:'15:30–18:00', txt:{en:'Back to The Shore — shower, rest, balcony sunset.', zh:'返回 The Shore —— 冲洗、休息、阳台看日落。'} },
      { t:'20:00–22:00', txt:{en:'Dinner at Rooftop Bar & Grill, Hilton Kota Kinabalu (booked, à la carte, ~RM150).', zh:'于亚庇希尔顿 Rooftop Bar & Grill 晚餐（已预订，单点，约RM150）。'} },
    ],
  ...
  { date:{en:'Jul 22 · Wed', zh:'7月22 · 周三'}, city:'kl',
    ...
    sched:[
      { t:'09:00–10:30', txt:{en:'Quick breakfast; check out before 12:00.', zh:'简单早餐；12:00 前退房。'} },
      { t:'13:00–13:30', txt:{en:'Grab to BKI Terminal 1; LoungeKey lounge before the flight (QR codes, both travellers).', zh:'Grab 前往亚庇机场 1 号航站楼；登机前使用 LoungeKey 贵宾室（QR 码，两人均有）。'} },
      { t:'15:10–17:45', txt:{en:'Batik Air OD1017, business class, BKI T1 → Subang (SZB) — note: not KLIA.', zh:'峇迪航空 OD1017 商务舱，BKI T1 → 梳邦机场（SZB）—— 注意：并非 KLIA。'} },
      { t:'18:25–19:30', txt:{en:'Booked transfer to Le Méridien Petaling Jaya — Executive Twin, 3 nights (Jul 22–25).', zh:'已订专车前往八打灵再也艾美酒店 —— 行政双床房，3 晚（7月22–25）。'} },
      { t:'20:30–22:30', txt:{en:'Dinner at Curate, Four Seasons Hotel KL — booked via OpenTable, ~RM500; timing depends on actual arrival.', zh:'于吉隆坡四季酒店 Curate 晚餐 —— 已通过 OpenTable 预订，约RM500；时间以实际到达为准。'} },
      { t:'22:30–', txt:{en:'Stroll: KLCC Park, Petronas Towers, Golden Triangle.', zh:'逛一逛：吉隆坡城中城公园、双子塔、吉隆坡金三角。'} },
    ],
